...
q = "5 5 7 10"
s= "10+5=15 (left: 5, 7, 15)\n15-7=8 (left: 5, 8)\n8*5=40 (left: 40)\n"
full_prompt = q
print(full_prompt)

print(list_of_states_to_expand(q, s, model_path =  "/home/mstojkov2025/misho/improved_policy_finetuning/finetuned_policy_models/sft-135/checkpoint-3000"))
