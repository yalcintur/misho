...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", type=str, default="/home/yalcintur/workspace/courses/misho/data/iter3_135_ds/value_training_data_iter_3-f.jsonl", help="Path to the training JSONL file")
    parser.add_argument("--val_file", type=str, default="/home/yalcintur/workspace/courses/misho/data/iter3_135_ds/value_validation_data_iter_3-f.jsonl", help="Path to the test JSONL file (optional)")
    parser.add_argument("--output_dir", type=str, default="/home/yalcintur/workspace/courses/misho/data/iter3_135_ds/value_ds", help="Directory to save the processed dataset")
